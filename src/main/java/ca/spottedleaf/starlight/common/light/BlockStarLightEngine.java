...
public final class BlockStarLightEngine extends StarLightEngine {
    ...
    protected final void checkBlock(final int worldX, final int worldY, final int worldZ) {
        ...
        final int emittedLevel = blockState.getLightValue() & emittedMask;
    ...
    protected Iterator<BlockPos> getSources(final IChunk chunk) {
    ...
    public void lightChunk(final IChunkLightProvider lightAccess, final IChunk chunk, final boolean needsEdgeChecks) {
        ...
        for (final Iterator<BlockPos> positions = this.getSources(chunk); positions.hasNext();) {
            ...
            final int emittedLight = blockState.getLightValue() & emittedMask;
